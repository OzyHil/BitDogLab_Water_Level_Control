...
void update_matrix_from_level(uint current_level, uint max_level) {
    ...
    for (int i = 0; i < NUM_PIXELS; i++) {
        uint32_t color = (matrix[i] == 1) ? rgb_matrix(BLUE) : rgb_matrix(DARK);
